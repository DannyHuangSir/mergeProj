(function(a) {
    a.sliderTabs = function(b, c) {
        ...
        d.selectedTab = e.defaultTab, d.init = function() {
            s = d.settings = a.extend({}, e, c), f.addClass("ui-slider-tabs"), i = f.children("div").addClass("ui-slider-tab-content").remove(), h = f.children("ul").addClass("ui-slider-tabs-list").remove(), h.children("li").remove().appendTo(h), d.count = h.children("li").length, k = a("<div class='ui-slider-tabs-list-wrapper'>"), j = a("<div class='ui-slider-tabs-list-container'>").append(h).appendTo(k), j.find("li").css("height", s.tabHeight + 2), j.find("li a").css("height", s.tabHeight + 2), m = a("<a href='#' class='ui-slider-left-arrow'><div></div></a>").css({
            ...
            }), l = a("<div class='ui-slider-tabs-content-container'>").append(i), s.position == "bottom" ? f.append(l).append(k.addClass("bottom")) : f.append(k).append(l), s.width && f.width(parseInt(s.width)), s.height && l.height(parseInt(s.height) - s.tabHeight), s.indicators && d.showIndicators(), d.selectTab(s.defaultTab), d.slideTabs("left", 0), w(), D(), f.delegate(".ui-slider-tabs-list li a", "click", function() {
                return !a(this).parent().hasClass("selected") && !q && d.selectTab(a(this).parent()), !1
            }), g && g.delegate(".ui-slider-tabs-indicator", "click", function() {
                !a(this).hasClass("selected") && !q && d.selectTab(a(this).index() + 1)
                ...
                var a = l.children(".selected");
                a.outerHeight() > l.outerHeight() && r && A(a)
            }, 100), C(), s.tabs || k.hide(), s.autoplay && setInterval(d.next, s.autoplay), f.unbind("mousewheel", function(a, b, c, e) {
                return b > 0 ? d.next() : b < 0 && d.prev(), !1
            })
        }, d.selectTab = function(a) {
            r = !1;
            var b = typeof a == "number" ? h.children("li:nth-child(" + a + ")") : a,
                c = b.find("a").attr("href").substr(1),
                e = l.children("#" + c);
            d.selectedTab = typeof a == "number" ? a : a.index() + 1, A(e), q = !0;
            var f = h.find(".selected").index() < b.index() ? "left" : "right";
            b.siblings().removeClass("selected"), s.classes.tabActive != "" && b.siblings().removeClass(s.classes.tabActive), b.addClass("selected").addClass(s.classes.tabActive), y(l.children(".ui-slider-tab-content:visible"), f), z(e), v(b), u()
        }, d.next = function() {
            q || (d.count === d.selectedTab ? d.selectTab(1) : d.selectTab(d.selectedTab + 1))
        }, d.prev = function() {
            q || (d.selectedTab === 1 ? d.selectTab(d.count) : d.selectTab(d.selectedTab - 1))
        ...
        var u = function() {
            ...
            w = function() {
                s.transition == "slide" && h.children("li").each(function(b, c) {
                    var d = h.children(".selected").index(),
                        e = a(c).index(),
                        f = l.children("#" + a(c).find("a").attr("href").substr(1));
                    d < e ? f.css({
                        left: l.width() + "px"
                    }) : d > e ? f.css({
                        left: "-" + l.width() + "px"
            ...
            y = function(a, b) {
                ...
                a.animate(x(l.width()).hide[c], s.transitionSpeed, s.transitionEasing, function() {
                    a.hide(), a.removeClass("selected"), q = !1, w()
                })
            },
            z = function(a) {
                a.show(), a.addClass(s.classes.panelActive).addClass("selected"), a.animate(x(l.width()).show[s.transition], s.transitionSpeed, s.transitionEasing, function() {
                    q = !1, r = !0, w()
                })
            },
            A = function(a) {
        ...
        easeInOutBounce: function(a, b, c, d, e) {
            return b < e / 2 ? $.easing.easeInBounce(a, b * 2, 0, d, e) * .5 + c : $.easing.easeOutBounce(a, b * 2 - e, 0, d, e) * .5 + d * .5 + c
        }
    }),
    function(a) {
        function d(b) {
        ...
        a.event.special.mousewheel = {
            ...
            mousewheel: function(a) {
                return a ? this.unbind("mousewheel", a) : this.trigger("mousewheel")
            },
