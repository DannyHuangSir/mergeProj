...
public class LoginServiceImpl implements ILoginService {
    ...
    @Override
	public String doLoinBxcz(String actionId, String code, String redirectUri) {
		return baseRestClient.postApiResponse(new Gson().toJson(new BxczLoginRequest(actionId,"authorization_code", code, redirectUri)), pbs102url, String.class).getResult();
	}
