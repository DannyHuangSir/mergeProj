...
public class TransMedicalTreatmentClaimMedicalInfoVo implements Serializable{
	...
	private String dtypeListStr;

	public String getDtypeListStr() {
		return dtypeListStr;
	}

	public void setDtypeListStr(String dtypeListStr) {
		this.dtypeListStr = dtypeListStr;
	}
	...
	public Float getClaimId() {
		return claimId;
	}

	public void setClaimId(Float claimId) {
