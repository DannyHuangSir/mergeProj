...
import com.twfhclife.eservice.onlineChange.service.IPolicyClaimService;
 ...
 */
@Service
public class PolicyClaimServiceImpl implements IPolicyClaimService {

	private static final Logger logger = LogManager.getLogger(PolicyClaimServiceImpl.class);
	...
	public byte[] getPDF(TransInsuranceClaimVo claimVo) {
		...
		try {
			...
			// 事故者資料-出生日期
			rptUtils.txt(claimVo.getBirdate(), 11, 1, 103, 674.5f);
			// 事故者資料-手機號碼
