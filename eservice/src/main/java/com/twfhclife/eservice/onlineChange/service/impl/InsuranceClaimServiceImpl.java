...
//				logger.error("filePath is: {}", filepath);
	...
	@Override
	public Integer getInsuranceClaimWhetherFirst(String policyNo, String insuranceClaimParameterCode) {
		int i = transInsuranceClaimDao.getInsuranceClaimWhetherFirst(policyNo, insuranceClaimParameterCode);
		if (i > 0) {
			return 1;
		}
		return 0;
