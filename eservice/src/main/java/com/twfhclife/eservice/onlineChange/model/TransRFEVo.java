...
public class TransRFEVo {
	 ...
	 * 此案件的上傳檔案狀態清單
	 */
	private List<TransMedicalTreatmentClaimFileDataVo> medicalTreatmentFileDatas;

	public List<TransMedicalTreatmentClaimFileDataVo> getMedicalTreatmentFileDatas() {
		return medicalTreatmentFileDatas;
	}

	public void setMedicalTreatmentFileDatas(List<TransMedicalTreatmentClaimFileDataVo> medicalTreatmentFileDatas) {
