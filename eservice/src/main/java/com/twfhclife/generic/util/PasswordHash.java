...
public class PasswordHash {
	public static final String PBKDF2_ALGORITHM = "pbkdf2-sha256";//"PBKDF2WithHmacSHA1";
...
//	}
	...
	public static void main(String[] args) {
		try {
			boolean res = validatePassword("12qwaszx", "RDDH0qNQqKn0uWAK98PYfSD/SusliMnPR/+ZdILJNqyuMX24zjPVltgakHmsnJx7KK5j9PabUiimHSaRrME/VA==");
