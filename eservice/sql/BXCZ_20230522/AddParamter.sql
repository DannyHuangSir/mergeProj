...
VALUES ((select max(parameter_id)+1 from ESERVICE_ADM.dbo.PARAMETER), N'eservice', N'DISCHARGE_HOSTIPAL', N'出院病摘', N'N', (select PARAMETER_CATEGORY_ID from ESERVICE_ADM.dbo.PARAMETER_CATEGORY where CATEGORY_CODE='INSURANCE_CLAIM_UPLOADFILE' AND SYSTEM_ID = 'eservice'), NULL, N'file-fr7', 1, N'N', NULL, getdate(), N'admin', getdate(), N'admin')
