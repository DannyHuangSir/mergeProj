...
ALTER TABLE ESERVICE.DBO.BXCZ_SIGN_RECORD ADD CAN_UPDATE NVARCHAR(1) DEFAULT 'Y';

ALTER TABLE ESERVICE.DBO.TRANS_MEDICAL_TREATMENT_CLAIM ADD UPLOAD_DATE datetime DEFAULT NULL;

ALTER TABLE ESERVICE.DBO.TRANS_INSURANCE_CLAIM ADD UPLOAD_DATE datetime DEFAULT NULL;

ALTER TABLE ESERVICE.DBO.TRANS_MEDICAL_TREATMENT_CLAIM ADD PRINT_DATE datetime DEFAULT NULL;

ALTER TABLE ESERVICE.DBO.TRANS_INSURANCE_CLAIM ADD PRINT_DATE datetime DEFAULT NULL;

ALTER TABLE ESERVICE.DBO.TRANS_INSURANCE_CLAIM ADD FILE_RECEIVE_DATE datetime DEFAULT NULL;

ALTER TABLE ESERVICE.DBO.TRANS_INSURANCE_CLAIM ADD SEND_ALLIANCE_DATE datetime DEFAULT NULL;

ALTER TABLE ESERVICE.DBO.TRANS_MEDICAL_TREATMENT_CLAIM ADD SEND_ALLIANCE_DATE datetime DEFAULT NULL;
