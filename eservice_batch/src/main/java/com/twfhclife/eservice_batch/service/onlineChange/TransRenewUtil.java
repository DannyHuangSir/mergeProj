 ...
 * @author all
 */
public class TransRenewUtil {

	private static final Logger logger = LogManager.getLogger(TransRenewUtil.class);
	private static final String TRANS_TYPE = "RENEW";
	...
	public void getChangeContent(StringBuilder beforeSb, StringBuilder afterSb, TransVo transVo) {
		...
		String renew = MyStringUtil.nullToString(transVo.getTransType());
		afterSb.append(MyStringUtil.nullToString(mapParam.get(renew))).append("\r\n");
	}
}