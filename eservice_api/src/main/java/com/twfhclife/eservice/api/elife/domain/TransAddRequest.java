...
public class TransAddRequest implements Serializable {
	...
	private TransDnsVo transDnsVo;

	public List<TransExtendAttrVo> getTransExtendAttrList() {
		return transExtendAttrList;
	}

	public void setTransExtendAttrList(
			List<TransExtendAttrVo> transExtendAttrList) {
	...
	public void setTransCancelContractVo(
			TransCancelContractVo transCancelContractVo) {
	...
	public void setTransFundNotificationVo(
			TransFundNotificationVo transFundNotificationVo) {
	...
	public TransDnsVo getTransDnsVo() {
		return transDnsVo;
	}

	public void setTransDnsVo(TransDnsVo transDnsVo) {
		this.transDnsVo = transDnsVo;
	}
