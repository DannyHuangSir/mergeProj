...
public class TransCtcSelectUtilVo implements Serializable {
	...
	private String pmdaPiTelO;
	private String pmdaPiTelOExt;
	...
	public String getPmdaPiTelO() {
		return pmdaPiTelO;
	}
	public void setPmdaPiTelO(String pmdaPiTelO) {
		this.pmdaPiTelO = pmdaPiTelO;
	}
	public String getPmdaPiTelOExt() {
		return pmdaPiTelOExt;
	}
	public void setPmdaPiTelOExt(String pmdaPiTelOExt) {
		this.pmdaPiTelOExt = pmdaPiTelOExt;
	}
