...
import com.twfhclife.eservice.onlineChange.model.AbstractOnlineChangeModelBean;
...
public class MedicalTreatmentClaimVo {
	 ...
	 * 此案件的上傳檔案狀態清單
	 */
	private List<MedicalTreatmentClaimFileDataVo> fileDatas;
	...
	//對應API-403(from ⾸家公司代號)
	private String fromCompanyId;
	//對應API-403(to 轉收公司代號)
	private String toCompanyId;
	//公司名稱
	private String otherInsucommpany;
	//保險金額
	private String otherInsuamount;
	//當前檔案是否下載狀態Y下載,N不進行下載
	...
	public void setFileData(List<MedicalTreatmentClaimFileDataVo> fileData) {
	...
	public String getOtherInsucommpany() {
		return otherInsucommpany;
	}

	public void setOtherInsucommpany(String otherInsucommpany) {
		this.otherInsucommpany = otherInsucommpany;
	}

	public String getOtherInsuamount() {
		return otherInsuamount;
	}

	public void setOtherInsuamount(String otherInsuamount) {
		this.otherInsuamount = otherInsuamount;
	}
