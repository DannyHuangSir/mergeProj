...
public class MedicalServiceImpl implements IMedicalService {
    ...
    public int addTransRequest(TransMedicalTreatmentClaimVo tvo) throws Exception {
            ...
            if(result > 0) {
                ...
                String mailTo = parameterDao.getParameterValueByCode(ApConstants.SYSTEM_ID_AMD, ApConstants.TWFHCLIFE_YQT_ADM);
                ...
                if(ApConstants.TRANS_STATUS_ABNORMAL.equals(status)) {
                    ...
                    vo = getMessageTriggerRequestVo(ApConstants.ELIFE_MAIL_036, receivers, paramMap, "email");
