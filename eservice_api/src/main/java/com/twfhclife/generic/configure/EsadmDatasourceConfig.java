 ...
 */
@Configuration
@MapperScan(basePackages = { "com.twfhclife.generic.dao.adm", "com.twfhclife.generic.dao" }, sqlSessionFactoryRef = "esadmSqlSessionFactory")
public class EsadmDatasourceConfig {
	...
	public DataSource esadmDataSource() {
		logger.debug("EsadmDatasourceConfig JNDI=" + esadmJNDIName);
		DataSource ds;
